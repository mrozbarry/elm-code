...
var _pairshaped$elm_firebase$Firebase_Database_Query$uuid = _pairshaped$elm_firebase$Native_Database_Query.uuid;
...
var _pairshaped$elm_firebase$Firebase_Database_Query$onEffects = F3(
	function (router, newSubs, oldState) {
		var isSameQuery = F2(
			function (a, b) {
				return _elm_lang$core$Native_Utils.eq(
					_pairshaped$elm_firebase$Firebase_Database_Query$uuid(a),
					_pairshaped$elm_firebase$Firebase_Database_Query$uuid(b));
			});
		var toAdd = function () {
			var notSubscribed = function (_p6) {
				var _p7 = _p6;
				return _elm_lang$core$List$isEmpty(
					A2(
						_elm_lang$core$List$filter,
						function (_p8) {
							var _p9 = _p8;
							return _elm_lang$core$Native_Utils.eq(_p9._0, _p7._0) && A2(isSameQuery, _p9._1, _p7._1);
						},
						oldState.subs));
			};
			return A2(_elm_lang$core$List$filter, notSubscribed, newSubs);
			...
			var subscribed = function (_p10) {
				...
				return _elm_lang$core$List$isEmpty(
					A2(
						...
						function (_p12) {
							var _p13 = _p12;
							return _elm_lang$core$Native_Utils.eq(_p13._0, _p11._0) && A2(isSameQuery, _p13._1, _p11._1);
						},
						newSubs));
			};
			return A2(_elm_lang$core$List$filter, subscribed, oldState.subs);
...
var _mrozbarry$elm_code$WorkerStatus$viewFunction = function (job) {
	var progress = A2(_elm_lang$core$Maybe$withDefault, 0.0, job.progress);
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(job.snippetId),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
...
var _mrozbarry$elm_code$WorkerStatus$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		A2(_elm_lang$core$List$map, _mrozbarry$elm_code$WorkerStatus$viewFunction, model.jobs));
};
var _mrozbarry$elm_code$WorkerStatus$initialModel = function (flags) {
	var app = _pairshaped$elm_firebase$Firebase$init(
		{apiKey: flags.firebaseApiKey, databaseURL: flags.firebaseDatabaseURL, authDomain: '', storageBucket: '', messagingSenderId: ''});
	var database = _pairshaped$elm_firebase$Firebase_Database$init(app);
	return {
		app: app,
		jobs: {ctor: '[]'},
		isSignedIn: true
...
var _mrozbarry$elm_code$WorkerStatus$init = function (flags) {
	return {
		ctor: '_Tuple2',
		_0: _mrozbarry$elm_code$WorkerStatus$initialModel(flags),
		_1: _elm_lang$core$Platform_Cmd$none
	};
};
var _mrozbarry$elm_code$WorkerStatus$Flags = F2(
	function (a, b) {
		return {firebaseApiKey: a, firebaseDatabaseURL: b};
	});
var _mrozbarry$elm_code$WorkerStatus$Model = F3(
	function (a, b, c) {
		return {app: a, jobs: b, isSignedIn: c};
	});
var _mrozbarry$elm_code$WorkerStatus$Job = F5(
	function (a, b, c, d, e) {
		return {snippetId: a, packageId: b, userId: c, progress: d, state: e};
	});
var _mrozbarry$elm_code$WorkerStatus$update = F2(
	function (msg, model) {
		var _p0 = msg;
		var decodeJobs = function () {
			var decodeJob = A6(
				_elm_lang$core$Json_Decode$map5,
				_mrozbarry$elm_code$WorkerStatus$Job,
				A2(_elm_lang$core$Json_Decode$field, 'snippetId', _elm_lang$core$Json_Decode$string),
				A2(_elm_lang$core$Json_Decode$field, 'packageId', _elm_lang$core$Json_Decode$string),
			...
			var decode = A2(
				...
				_elm_lang$core$Json_Decode$keyValuePairs(decodeJob));
			return A2(
...
var _mrozbarry$elm_code$WorkerStatus$TasksUpdated = function (a) {
	return {ctor: 'TasksUpdated', _0: a};
};
var _mrozbarry$elm_code$WorkerStatus$subscriptions = function (model) {
	var jobReference = A2(
		_pairshaped$elm_firebase$Firebase_Database$ref,
		_elm_lang$core$Maybe$Just('compile-jobs'),
		_pairshaped$elm_firebase$Firebase_Database$init(model.app));
	return _elm_lang$core$Native_Utils.eq(model.isSignedIn, true) ? A2(
		_elm_lang$core$Debug$log,
		'doing sub',
		A3(_pairshaped$elm_firebase$Firebase_Database_Reference$on, 'value', jobReference, _mrozbarry$elm_code$WorkerStatus$TasksUpdated)) : A2(_elm_lang$core$Debug$log, 'ignoring sub', _elm_lang$core$Platform_Sub$none);
};
var _mrozbarry$elm_code$WorkerStatus$main = _elm_lang$html$Html$programWithFlags(
	{init: _mrozbarry$elm_code$WorkerStatus$init, update: _mrozbarry$elm_code$WorkerStatus$update, subscriptions: _mrozbarry$elm_code$WorkerStatus$subscriptions, view: _mrozbarry$elm_code$WorkerStatus$view})(
	A2(
		_elm_lang$core$Json_Decode$andThen,
			...
			return A2(
				...
				function (firebaseDatabaseURL) {
					return _elm_lang$core$Json_Decode$succeed(
						{firebaseApiKey: firebaseApiKey, firebaseDatabaseURL: firebaseDatabaseURL});
				},
				A2(_elm_lang$core$Json_Decode$field, 'firebaseDatabaseURL', _elm_lang$core$Json_Decode$string));
		},
		A2(_elm_lang$core$Json_Decode$field, 'firebaseApiKey', _elm_lang$core$Json_Decode$string)));

var Elm = {};
Elm['WorkerStatus'] = Elm['WorkerStatus'] || {};
if (typeof _mrozbarry$elm_code$WorkerStatus$main !== 'undefined') {
    _mrozbarry$elm_code$WorkerStatus$main(Elm['WorkerStatus'], 'WorkerStatus', undefined);
}
